...
let englishLettersShiftCapslock = [
  "!",
  "@",
  "#",
  "$",
...
let russianLettersShiftCapslock = [
  "!",
  '"',
  "№",
  ";",
...
let speechFunction = () => {
  if ("SpeechRecognition" in window || "webkitSpeechRecognition" in window) {
    ...
    speechHelper.innerHTML =
      "Браузер не поддерживает функцию распознавания речи";
  }
};
speechFunction();
